...
if __name__ == '__main__':
    pytest.main(['-v'])
    #  запуск из командной строки -> pytest testprime.py -v
    #  запуск doctests -> pytest --doctest-modules ..\doctest\prime.py -v
    #  запуск doctests -> pytest ..\unittest\test_prime.py -v